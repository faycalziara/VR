    ...
    init: function() {
      ...
      $.each(this.settings.buttons, function(index, value) {
        var v = networks[value],
          ...
          $component = $("<a>", { title: base.settings.title, class: value + " pop-upper"}).attr('data-url',v["url"]).attr("href", _href).attr('onclick',"share_on('"+value+"')").attr("title", _text_output).append($icon).addClass("without-counter");
