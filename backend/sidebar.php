...
$collapse_admin_show = "";
$collapse_admin_active = "";
$collapse_admin_expanded = "false";
$collapse_admin_c = "collapsed";
switch ($page) {
    case 'dashboard':
    ...
    case 'statistics_learning':
        $statistics_learning_active = "active";
        $collapse_stats_show = "show";
        $collapse_stats_active = "active";
        $collapse_stats_expanded = "true";
        $collapse_stats_c = "";
    ...
    case 'settings':
        ...
        $collapse_admin_show = "show";
        $collapse_admin_active = "active";
        $collapse_admin_expanded = "true";
        $collapse_admin_c = "";
        break;
    case 'updater':
    ...
    case 'bulk_translate':
        ...
        break;
    case 'custom_domain':
        $custom_domain_active = "active";
        break;
}
$virtual_tours = get_virtual_tours($id_user,'count');
    ...
    if ($user_info['id_plan'] != 0) {
        ...
        if (!empty($customize_menu_json)) {
            ...
            if(isset($customize_menu['statistics_tour'])) {
                ...
                if ($customize_menu['statistics_learning'] == 0) $statistics_learning_visible = "hidden_menu";
            }
            ...
            if ($customize_menu['custom_domain'] == 0) $custom_domain_visible = "hidden_menu";
...
if(!$settings['enable_custom_domain']) {
    $custom_domain_visible = "hidden_menu";
}
...
if($publish_visible=="" || $custom_domain_visible=="" || $collected_data_visible=="" || $preview_visible=="") {
    $divider_2_visible = "";
}
$custom_domain_num = 0;
...
<ul class="navbar-nav <?php echo ($settings['sidebar']=='flat') ? 'bg-flat-primary' : 'bg-gradient-primary'; ?> sidebar sidebar-dark accordion noselect" id="accordionSidebar">
    ...
    <li class="nav-item <?php echo $collapse_stats_active; ?> <?php echo $statistics_visible; ?>">
        ...
        <div id="collapse_stats" class="collapse <?php echo $collapse_stats_show; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="glass_effect_sidebar py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?php echo $vt_disabled; ?> <?php echo $statistics_learning_active; ?> <?php echo $statistics_learning_visible; ?>" href="index.php?p=statistics_learning"><i class="fas fa-fw fa-graduation-cap"></i> <span><?php echo _("Learning"); ?></span></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item <?php echo $custom_domain_active; ?> <?php echo $custom_domain_visible; ?>">
        <a class="nav-link" id="custom_domain_menu_item" href="index.php?p=custom_domain">
            <i class="fas fa-fw fa-sitemap"></i>
            <span><?php echo _("Custom Domains"); ?> <?php echo ($custom_domain_num>0) ? '<i style="font-size:11px;" class="text-warning fas fa-exclamation-circle"></i>' : ''; ?></span></a>
    </li>
    ...
    <?php if($user_info['role']=='administrator' && $user_info['super_admin']) : ?>
        <hr class="sidebar-divider d-none d-md-block">
        <li class="nav-item <?php echo $collapse_admin_active; ?>">
            <a class="nav-link <?php echo $collapse_admin_c; ?>" href="#" data-toggle="collapse" data-target="#collapse_admin" aria-expanded="<?php echo $collapse_admin_expanded; ?>" aria-controls="collapse_admin">
                <i class="fas fa-fw fa-user-doctor"></i>
                <span><?php echo _("Administrator"); ?></span>
            </a>
            <div id="collapse_admin" class="collapse <?php echo $collapse_admin_show; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                <div class="glass_effect_sidebar py-2 collapse-inner rounded">
                    <a class="collapse-item <?php echo $settings_active; ?>" href="index.php?p=settings"><i class="fas fa-fw fa-cogs"></i> <span><?php echo _("Settings"); ?></span></a>
                    <a class="collapse-item <?php echo $updater_active; ?>" href="index.php?p=updater"><i class="fas fa-fw fa-download"></i> <span><?php echo _("Upgrade"); ?> <?php echo (version_compare($version_a,$latest_version)==-1) ? '<i style="font-size:11px;" class="text-warning fas fa-exclamation-circle"></i>' : ''; ?></span></a>
                    <a class="collapse-item <?php echo $users_active; ?>" href="index.php?p=users"><i class="fas fa-fw fa-users"></i> <span><?php echo _("Users"); ?></span></a>
                    <a class="collapse-item <?php echo $plans_active; ?>" href="index.php?p=plans"><i class="fas fa-fw fa-crown"></i> <span><?php echo _("Plans"); ?></span></a>
                    <a class="collapse-item <?php echo $services_active; ?>" href="index.php?p=services"><i class="fas fa-fw fa-hand-holding-usd"></i> <span><?php echo _("Services"); ?></span></a>
                </div>
            </div>
        </li>
    <?php endif; ?>
    ...
    <?php if($user_info['role']!='editor') : ?>
        ...
        <li class="nav-item <?php echo $subscription_active; ?>">
            <a class="nav-link" href="index.php?p=change_plan">
                <i class="fas fa-fw fa-credit-card"></i>
                <span><?php echo _("Subscription"); ?></span></a>
        </li>
        <?php endif; ?>
        <?php if($settings['buy_services']) : ?>
            <li class="nav-item <?php echo $buy_services_active; ?>">
                <a class="nav-link" href="index.php?p=buy_service">
                    <i class="fas fa-fw fa-hand-holding-usd"></i>
                    <span><?php echo _("Services"); ?></span></a>
            </li>
        <?php endif; ?>
    <?php endif; ?>
