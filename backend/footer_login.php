...
$array_lang=array();
try {
    $query_lang = "SELECT * FROM svt_settings_lang WHERE language='$language' AND id_settings=1";
    ...
    if(!empty($settings['footer_link_1']) && !empty($array_lang['footer_link_1'])) {
        $settings['footer_link_1']=$array_lang['footer_link_1'];
    }
    if(!empty($settings['footer_link_2']) && !empty($array_lang['footer_link_2'])) {
        $settings['footer_link_2']=$array_lang['footer_link_2'];
    }
    if(!empty($settings['footer_link_3']) && !empty($array_lang['footer_link_3'])) {
        $settings['footer_link_3']=$array_lang['footer_link_3'];
    }
    if(!empty($settings['footer_value_1']) && !empty($array_lang['footer_value_1'])) {
        $settings['footer_value_1']=$array_lang['footer_value_1'];
    }
    if(!empty($settings['footer_value_2']) && !empty($array_lang['footer_value_2'])) {
        $settings['footer_value_2']=$array_lang['footer_value_2'];
    }
    if(!empty($settings['footer_value_3']) && !empty($array_lang['footer_value_3'])) {
        $settings['footer_value_3']=$array_lang['footer_value_3'];
    }
