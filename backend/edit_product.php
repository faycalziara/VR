                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input <?php echo ($product['purchase_type']=='cart') ? 'disabled' : ''; ?> type="text" class="form-control" id="custom_currency" placeholder="<?php echo get_symbol_currency($virtual_tour['snipcart_currency']); ?>" value="<?php echo ($product['purchase_type']=='cart') ? $virtual_tour['snipcart_currency'] : $product['custom_currency'];?>" />
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
