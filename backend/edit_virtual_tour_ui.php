    ...
    <div class="col-md-12 mb-2 editor_ui_container">
        <div class="card shadow mb-3">
            <div id="editor_ui_div" style="background: white;" class="card-body p-0 position-relative">
                ...
                <div style="margin-bottom:-3px;opacity:0;" id="ui_container" class="noselect">
                    ...
                    <div class="menu_controls noselect">
                        ...
                        <div class="dropdown">
                            ...
                            <p id="icons_control_menu" style="order:<?php echo ($ui_style['controls']['icons']['order']); ?>" data-ui-target="ui_edit_icons" data-id-color="icons" class="icons_control active_control <?php echo ($ui_style['controls']['icons']['type']=='button') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_icons_toggle'])?'':'ui_disabled'; ?>"><?php echo print_library_icon('icons','list'); ?><i style="<?php echo ($ui_style['controls']['icons']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['icons']['icon']; ?>"></i>&nbsp;&nbsp;&nbsp;<?php echo _("Icons"); ?> <i class="fa fa-circle <?php echo ($virtual_tour['show_icons_toggle']==1) ? 'active':'not_active'; ?>"></i></p>
                    ...
                    <div title="<?php echo _("Fullscreen"); ?>" data-ui-target="ui_edit_fullscreen" data-id-color="fullscreen" class="small-element fullscreen_control noselect <?php echo ($virtual_tour['show_fullscreen'])?'':'ui_disabled'; ?> <?php echo ($ui_style['controls']['fullscreen_alt']['type']=='button') ? 'ui_hidden' : ''; ?>"><i class="fas fa-expand"></i></div>
                    ...
                    <div class="controls_bottom <?php echo ($ui_style['buttons_style']!='default') ? $ui_style['buttons_style']."-btn" : ''; ?> <?php echo ($ui_style['buttons_size']!='default') ? $ui_style['buttons_size']."-btn" : ''; ?>">
                        <div id="controls_bottom_left">
                            ...
                            <div id="icons_control_left" title="<?php echo _("Icons"); ?>" style="order:<?php echo ($ui_style['controls']['icons']['order']); ?>;" data-ui-target="ui_edit_icons" data-id-color="icons" class="small-element controls_btn icons_control <?php echo ($ui_style['controls']['icons']['position']=='left') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['icons']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_icons_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('icons','icon'); ?><i style="<?php echo ($ui_style['controls']['icons']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['icons']['icon']; ?>"></i></div>
                            <div id="measures_control_left" title="<?php echo _("Measures"); ?>" style="order:<?php echo ($ui_style['controls']['measures']['order']); ?>;" data-ui-target="ui_edit_measures" data-id-color="icons" class="small-element controls_btn measures_control <?php echo ($ui_style['controls']['measures']['position']=='left') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['measures']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_measures_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('measures','icon'); ?><i style="<?php echo ($ui_style['controls']['measures']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['measures']['icon']; ?>"></i></div>
                            <div id="annotations_control_left" title="<?php echo _("Annotations"); ?>" style="order:<?php echo ($ui_style['controls']['annotations']['order']); ?>;" data-ui-target="ui_edit_annotations" data-id-color="icons" class="small-element controls_btn annotations_control <?php echo ($ui_style['controls']['annotations']['position']=='left') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['annotations']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_annotations']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('annotations','icon'); ?><i style="<?php echo ($ui_style['controls']['annotations']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['annotations']['icon']; ?>"></i></div>
                            <div id="fullscreen_alt_control_left" title="<?php echo _("Fullscreen"); ?>" style="order:<?php echo ($ui_style['controls']['fullscreen_alt']['order']); ?>;" data-ui-target="ui_edit_fullscreen" data-id-color="fullscreen_alt" class="small-element controls_btn fullscreen_alt_control <?php echo ($ui_style['controls']['fullscreen_alt']['position']=='left') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['fullscreen_alt']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_fullscreen']==0)?'ui_disabled':''; ?>"><i class="fas fa-expand"></i></div>
                        </div>
                        <div class="controls_bottom_center_wrap">
                            <div id="controls_bottom_center">
                                ...
                                <div id="icons_control_center" title="<?php echo _("Icons"); ?>" style="order:<?php echo ($ui_style['controls']['icons']['order']); ?>;" data-ui-target="ui_edit_icons" data-id-color="icons" class="small-element controls_btn icons_control <?php echo ($ui_style['controls']['icons']['position']=='center') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['icons']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_icons_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('icons','icon'); ?><i style="<?php echo ($ui_style['controls']['icons']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['icons']['icon']; ?>"></i></div>
                                <div id="measures_control_center" title="<?php echo _("Measures"); ?>" style="order:<?php echo ($ui_style['controls']['measures']['order']); ?>;" data-ui-target="ui_edit_measures" data-id-color="icons" class="small-element controls_btn measures_control <?php echo ($ui_style['controls']['measures']['position']=='center') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['measures']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_measures_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('measures','icon'); ?><i style="<?php echo ($ui_style['controls']['measures']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['measures']['icon']; ?>"></i></div>
                                <div id="annotations_control_center" title="<?php echo _("Annotations"); ?>" style="order:<?php echo ($ui_style['controls']['annotations']['order']); ?>;" data-ui-target="ui_edit_annotations" data-id-color="icons" class="small-element controls_btn annotations_control <?php echo ($ui_style['controls']['annotations']['position']=='center') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['annotations']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_annotations']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('annotations','icon'); ?><i style="<?php echo ($ui_style['controls']['annotations']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['annotations']['icon']; ?>"></i></div>
                                <div id="fullscreen_alt_control_center" title="<?php echo _("Fullscreen"); ?>" style="order:<?php echo ($ui_style['controls']['fullscreen_alt']['order']); ?>;" data-ui-target="ui_edit_fullscreen" data-id-color="fullscreen_alt" class="small-element controls_btn fullscreen_alt_control <?php echo ($ui_style['controls']['fullscreen_alt']['position']=='center') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['fullscreen_alt']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_fullscreen']==0)?'ui_disabled':''; ?>"><i class="fas fa-expand"></i></div>
                            </div>
                        </div>
                        <div id="controls_bottom_right">
                            ...
                            <div id="icons_control_right" title="<?php echo _("Icons"); ?>" style="order:<?php echo ($ui_style['controls']['icons']['order']); ?>;" data-ui-target="ui_edit_icons" data-id-color="icons" class="small-element controls_btn icons_control <?php echo ($ui_style['controls']['icons']['position']=='right') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['icons']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_icons_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('icons','icon'); ?><i style="<?php echo ($ui_style['controls']['icons']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['icons']['icon']; ?>"></i></div>
                            <div id="measures_control_right" title="<?php echo _("Measures"); ?>" style="order:<?php echo ($ui_style['controls']['measures']['order']); ?>;" data-ui-target="ui_edit_measures" data-id-color="icons" class="small-element controls_btn measures_control <?php echo ($ui_style['controls']['measures']['position']=='right') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['measures']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_measures_toggle']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('measures','icon'); ?><i style="<?php echo ($ui_style['controls']['measures']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['measures']['icon']; ?>"></i></div>
                            <div id="annotations_control_right" title="<?php echo _("Annotations"); ?>" style="order:<?php echo ($ui_style['controls']['annotations']['order']); ?>;" data-ui-target="ui_edit_annotations" data-id-color="icons" class="small-element controls_btn annotations_control <?php echo ($ui_style['controls']['annotations']['position']=='right') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['annotations']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_annotations']==0)?'ui_disabled':''; ?>"><?php echo print_library_icon('annotations','icon'); ?><i style="<?php echo ($ui_style['controls']['annotations']['icon_library']!=0) ? 'display:none':''; ?>" class="<?php echo $ui_style['controls']['annotations']['icon']; ?>"></i></div>
                            <div id="fullscreen_alt_control_right" title="<?php echo _("Fullscreen"); ?>" style="order:<?php echo ($ui_style['controls']['fullscreen_alt']['order']); ?>;" data-ui-target="ui_edit_fullscreen" data-id-color="fullscreen_alt" class="small-element controls_btn fullscreen_alt_control <?php echo ($ui_style['controls']['fullscreen_alt']['position']=='right') ? '' : 'ui_hidden'; ?> <?php echo ($ui_style['controls']['fullscreen_alt']['type']=='menu') ? 'ui_hidden' : ''; ?> <?php echo ($virtual_tour['show_fullscreen']==0)?'ui_disabled':''; ?>"><i class="fas fa-expand"></i></div>
                        </div>
                    </div>
                ...
                <div id="ui_edit_visitors" class="ui_edit_box noselect" style="top:280px">
                ...
                <div id="ui_edit_fullscreen" class="ui_edit_box noselect">
                    ...
                    <div class="ui_content_box">
                        ...
                        <div class="row fullscreen_alt_colors <?php echo ($ui_style['controls']['fullscreen_alt']['type']=='menu') ? 'd-none' : ''; ?>">
                            <div class="col-md-6">
                                <?php echo print_ui_main_color('fullscreen_alt',true,true); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo print_ui_hover_color('fullscreen_alt',true,true); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="ui_edit_snapshot" class="ui_edit_box noselect">
                    ...
                    <div class="ui_content_box">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo print_ui_main_color('snapshot',true,true); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo print_ui_hover_color('snapshot',true,true); ?>
                            </div>
                        </div>
                    </div>
                </div>
