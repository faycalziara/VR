...
session_write_close();
$query = "DELETE FROM svt_poi_staging WHERE id=$id_staging AND id_poi=$id_poi;";
$result = $mysqli->query($query);
if($result) {
    $mysqli->query("ALTER TABLE svt_poi_staging AUTO_INCREMENT = 1;");
    $staging_items = array();
