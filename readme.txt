...
=====CHANGELOG=====
8.6.1
- added more customization of learning style
- added the ability to translate also POI gallery captions
- added the ability to allow download of images from Tour and POI Gallery
- added the ability to insert custom head PHP code for backend and viewer into settings
- added mobile view on preview
- added quick preview action in top bar
- added quick room preview inside room list
- VR mode now supports marker and POI icons if set as custom icon library
- in room list added a button to open the direct room link
- fixed an issue that caused the device orientation icon and webvr to display on some desktops
- fixed an issue with learning mode that prevented the marker from being unlocked if there were no POIs in the room
- fixed a visualization issue on POI editor window
- fixed an issue on saving rooms list on multilanguage tours
- fixed an issue on saving new UI presets / Versions
8.6
- added learning mode to virtual tours
- added the ability to set initial room for a tour: first, random or select
- added the ability to hide multiple room views into the Editor UI
- added the ability to set auto rotation and device orientation enabled but hidden into the Editor UI
- added the ability to hide the arrows slider only on mobile or mobile/desktop
- added the ability to duplicate markers
- added the ability to duplicate POI inside multiple rooms
- added the ability to duplicate maps
- added the ability to clone also markers on duplicate rooms
- added the ability to set a round mask for nadir logo
- added the ability to hide a grouped POI when opened
- added the ability to open vr mode inside a new window
- added a shortcut for edit room inside markers, pois and measurements
- added a button to open the link of the slideshow, video project, 360 video, gallery, icons, media library and poi contents
- now the room selected in the markers/poi/measures is maintained on page reload
- now when duplicating a tour also the VR icon images are copied
- now the room menu list is synced between all the languages
- added the ability to assign the category to the room directly in the edit page
- fixed automatic device orientation on Android devices
- fixed an issue with the avatar video disappearing even if the "hide when it ends" option was not selected
- fixed an issue when regenerating panoramas that caused the stereo image to disappear
- fixed an issue with tour language switching
- fixed an issue with bulk translate for Staging items
- fixed an issue where the room slider wasn't working properly on mobile when there were grouped rooms
- improved security
8.5.1
- added the ability to toggle PWA on or off
- added the ability to set the logo and powered-by to be displayed only on Desktop, only on Mobile or both
- added the ability to set the logo and powered-by opacity and opacity hover
- added the ability to set size or hide VR icons
- redesigned the share modal
- now if a tour is protected the VR version can not be accessed directly
- fixed an issue with measures and annotation toggle not being visible if set to visible, content hidden
- fixed an issue with round bar corners on left buttons
- fixed an issue with powered-by position
- fixed an issue with some flags position into backend
- fixed an issue with automatic language detection
- fixed an issue with screenshot feature inside the edit room
- fixed an issue adding virtual staging POI not working on some systems
- fixed an issue with virtual staging not working on some mobiles
- fixed an issue with snapshot that sometimes return zoomed images
- fixed an issue with showcase link not opening on some systems
- fixed an issue in VR mode when a stereo image is provided the hotspots are in the wrong position
8.5
- (SaaS) admin can now resend an activation email if the customer is not yet active
- (SaaS) when the administrator manually activates a customer account, an email is sent to the latter
- (SaaS) now the language selected during registration is inserted as the default language of the user profile
- added POI virtual staging, to change part of the panorama individually
- added the ability to set icons, measures and annotations toggle to visible but hidden into the Editor UI
- added the ability to set icons, measures and annotations as button inside Editor UI
- added a tour option to allow multiple POIs to remain open simultaneously or limit it to one
- added a tour option to enable or disable closing POIs when clicking outside
- added the ability to set the style and size of the buttons in the UI editor
- added language selection when creating the tour
- added a list button into globe view
- added automatic browser language detection for initial login/registration in the backend and also in multilingual tours
- effects are now also applied when taking a screenshot
- fixed an issue on saving editor ui versions
- fixed an issue on Backblaze Europe endpoint
- fixed an issue downloading the standalone version of the tour
- fixed an issue on deleting some zip files with special characters
- fixed an issue with visualization on tour list for customers when a tour is locked
- fixed an issue with translations that were incorrectly displayed if the tour language is changed and disabled the language choice
- fixed an issue that prevented tour protection from being saved in some cases
- fixed color issue on whatsapp button
8.4.2
- (SaaS) fixed an issue with manual add service
- (SaaS) added more information for services inside the profile of the user
- (SaaS) added the ability to change the number of rooms before purchasing a tour service
- (SaaS) administrator can now modify and delete a purchased server for a user
- (SaaS) fixed an issue with editing the user with editor role
- fixed an issue with snapshot not working on some browsers
- fixed an issue with 360 video not playing on mobile
- fixed an issue with HFOV on mobile when device orientation is enabled
- fixed an issue with woocommerce that prevented adding to cart some products with double quotes within the variant name
8.4.1
- fixed an issue that prevented the editor UI from opening
8.4
- (SaaS) added the ability to set visibility for services
- (SaaS) added the ability for administrator to set manually the credits for a service to assign to a user
- (SaaS) added the ability to change the order position of plans
- (SaaS) added the ability to change the order position of services
- (SaaS) added Live chat (Tawk.to) inside the backend
- added the ability to change the order position of categories
- added the ability to take a snapshot directly within the tour
- added the ability to set woocommerce checkout and cart in a pop-up
- added the ability to group rooms in the slider if they are part of the same category
- added PWA popup
- added a fade audio effect to generated videos
- updated A.I. Enhance
- partial panoramas now display correctly on mobile devices
- fixed VR cursor animation
- fixed some issues with audio
- fixed some translation labels missing
- fixed an issue when logging in with 2fa that did not remember credentials
8.3
- (SaaS) added the ability to lock / unlock a tour for customers
- (Saas) added the ability to add services, which can be purchased by customers
- added the ability to pause avatar video when playing
- added the ability to set a marker or poi as "sticky" (it will be visible even when it is slightly out of sight)
- added the ability to insert links inside the callout description
- added more information to user profile
- added last visit date inside the tour list
- fixed existing panoramas modal not opening on some systems
- fixed an issue where when the tour was embedded in another site it would cause the parent site to scroll on loading
8.2.2
- now the versions are also taken when creating tour from samples and templates
- now the tour version link have the name inside the url instead of the id
- blocked video generation for those users who had expired plans
- fixed an issue with user notes that in some cases caused an error when viewing the list
- fixed an issue with links in publishing when multiple versions were present
- fixed an issue on saving callout
- fixed an issue with friendly URL with version showing invalid link
- fixed tooltip on map not visible when in fullscreen
- fixed an issue on mobile ios that causing freeze the browser with avatar video
- fixed an issue that slows down the loading of the POI page when a Woocommerce store was set up
- fixed some missing translations
8.2.1
- fixed an installation issue on some systems
- fixed showcase not working on some systems
- fixed an issue that prevented tours from displaying on some systems
- fixed an issue that prevented globes from opening when a custom language was set
- Fixed an issue where the tour list would not show up when adding to the globe
- fixed wrong category translations on edit tour
- fixed incorrect position of the language icon in some backend places
- fixed "loading info" not being saved into versions
- fixed an issue with the callout description editor
- fixed a fullscreen button positioning issue in the UI editor
8.2
- added languages: Khmer, Danish, Norwegian, Estonian, Lithuanian, Latvian, Slovak, Slovenian, Ukrainian
- added RTL support
- added Custom Domains
- added the ability to set icon and color for button categories for showcase filters
- added multilanguage support to showcases
- added the ability to translate also categories, footer, extra menu items and features
- added the ability to override VR icons for each tour
- added the ability to select multiple languages also for external tours
- added the ability to hide the player controls of the POI audio
- added the option "visible, opened (only on desktop)" for Map on Editor UI
- moved visitors settings inside the Editor UI
- added the ability to change visitors colors
- added the ability to move the fullscreen to below buttons on Editor UI
- added user notes visible only to administrators
- added WYSIWYG editor to callout descriptions
- added the ability to create multiple version of a tour on Editor UI
- extended Presets to save all the editor UI parameters
- into Publish section, Tour and Rooms list now you can see the status of tour/room if published or not to Google Street View
- when creating a new external tour a popup appears to insert the link
- audio transitions in tours are now smoother
- support for wechat share meta tags
- fixed panorama environment on embedded 3d object not working
- fixed an issue when creating an external tour where you were prompted to add rooms
- fixed an issue with POI video inside VR not playing on some devices
8.1
